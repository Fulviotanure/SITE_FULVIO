...
## 6. URLs de Download Direto dos Executáveis (GitHub Releases)

- **FT PDF (Edição Completa v2.0.0):**
  - Executável Direto: `https://github.com/Fulviotanure/ft-pdf/releases/download/v2.0.0/FtPdf.exe`
  - Pacote ZIP: `https://github.com/Fulviotanure/ft-pdf/releases/download/v2.0.0/FT-PDF-Windows-x64.zip`
- **FT PDF Lite (Edição Ultraleve v2.0.0):**
  - Executável Direto: `https://github.com/Fulviotanure/ft-pdf/releases/download/lite-v2.0.0/FtPdfLite.exe`
  - Pacote ZIP: `https://github.com/Fulviotanure/ft-pdf/releases/download/lite-v2.0.0/FT-PDF-Lite-Windows-x64.zip`
